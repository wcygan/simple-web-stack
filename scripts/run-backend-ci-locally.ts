...
const WORKFLOW_FILE = ".github/workflows/backend-ci.yml";
const JOB_NAME = "build_and_test_backend"; // Must match the job name in the workflow file
...
console.log(cyan("Running Backend CI locally using act..."));
...
if (eventType === "pull_request") {
  ...
  console.log("changes in the 'backend/' directory on your current branch that are not on 'main'.");
  console.log(green("Example to create dummy changes for testing:"));
  console.log("  git checkout main && git pull origin main");
  console.log("  git checkout -b temp-backend-test");
  console.log("  mkdir -p backend/act_test_dummy && touch backend/act_test_dummy/file.txt");
  console.log("  git add backend/act_test_dummy/file.txt");
  console.log("  git commit -m 'feat: dummy change in backend for act testing'");
  console.log("Then run this script: deno task ci:backend pull_request");
  console.log("After testing, you can clean up: git checkout main && git branch -D temp-backend-test");
  console.log(yellow("-----------------------------------------------------"));
...
console.log(yellow("-----------------------------------------------------"));
console.log(green("Backend CI local run finished.")); 